...
const MusicBottom = ({ hidden, currenbuttonPlay, imgUrl, music, preMusic, play, pauseMp3, playMp3, music1, nextMusic, changeTime, currentime, duration, changeValue }) => {
    return (
        <>
            <div className={hidden ? 'musicbottom fixed bottom-0 left-0 right-0' : 'musicbottom fixed bottom-0 left-0 right-0 hidden'}>
                <div className='flex items-center justify-between px-[120px] py-[20px]'>
                    ...
                    <div className='w-[50%]'>
                        <div className='flex text-[40px] justify-center mb-[20px]'>
                            <BiSolidSkipPreviousCircle onClick={() => preMusic(currenbuttonPlay)} className='mx-[10px] cursor-pointer text-[#16b8f8]' />
                            {play ? <FaRegPauseCircle onClick={() => pauseMp3(currenbuttonPlay)} className='mx-[10px] cursor-pointer  text-[#16b8f8]' /> : <FaRegCirclePlay onClick={() => playMp3(music[currenbuttonPlay].link, currenbuttonPlay)} className='mx-[10px] cursor-pointer  text-[#16b8f8]' />}
                            <BiSolidSkipNextCircle onClick={() => nextMusic(currenbuttonPlay)} className='mx-[10px] cursor-pointer  text-[#16b8f8]' />
                        </div>
